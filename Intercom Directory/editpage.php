...
// Fetch all contact numbers with FIXED organizational info
$query = "SELECT 
    n.numbers,
    n.description,
    n.head,
    ...
    -- Get the actual names from the hierarchy tables
                        ...
                        <tbody>
                            <?php foreach ($numbers as $number): ?>
                                <tr>
                                    ...
                                    <!-- Organization Column - Show organizational hierarchy -->
