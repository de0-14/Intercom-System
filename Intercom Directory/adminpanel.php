...
// Get admin notifications for header
...
.chat-item, .user-item, .admin-item, .notification-item, .message-sender {
    position: relative;
}
</style>
</head>
    ...
    <ul class="nav">
        ...
        <?php if (isLoggedIn()): ?>
            <?php if (isAdmin()): ?>
                ...
                <li><a href="adminpanel.php" class="notification-indicator">
                    Admin Panel 
                        ...
                        <div class="hierarchy-tooltip">
                            ...
                            <div class="hierarchy-info">
                                <div class="hierarchy-row">
                                    ...
                                    <div class="hierarchy-value"><?php echo htmlspecialchars($user_hierarchy['role_name'] ?? 'N/A'); ?></div>
                                </div>
                                <?php if ($user_hierarchy['position']): ?>
                                <div class="hierarchy-row">
                                    <div class="hierarchy-label">Position:</div>
                                    <div class="hierarchy-value"><?php echo htmlspecialchars($user_hierarchy['position']); ?></div>
                                </div>
                                <?php endif; ?>
                                <?php if ($user_hierarchy['division']): ?>
                                <div class="hierarchy-row">
                                    <div class="hierarchy-label">Division:</div>
                                    <div class="hierarchy-value"><?php echo htmlspecialchars($user_hierarchy['division']); ?></div>
                                </div>
                                <?php endif; ?>
                                <?php if ($user_hierarchy['department']): ?>
                                <div class="hierarchy-row">
                                    <div class="hierarchy-label">Department:</div>
                                    <div class="hierarchy-value"><?php echo htmlspecialchars($user_hierarchy['department']); ?></div>
                                </div>
                                <?php endif; ?>
                                <?php if ($user_hierarchy['unit']): ?>
                                <div class="hierarchy-row">
                                    <div class="hierarchy-label">Unit:</div>
                                    <div class="hierarchy-value"><?php echo htmlspecialchars($user_hierarchy['unit']); ?></div>
                                </div>
                                <?php endif; ?>
                                <?php if ($user_hierarchy['office']): ?>
                                <div class="hierarchy-row">
                                    <div class="hierarchy-label">Office:</div>
                                    <div class="hierarchy-value"><?php echo htmlspecialchars($user_hierarchy['office']); ?></div>
                                </div>
                                <?php endif; ?>
                                <?php if ($user_hierarchy['head_info'] && isset($user_hierarchy['head_info']['head_name'])): ?>
                                <div class="hierarchy-divider"></div>
                                <div class="hierarchy-row">
                                    <div class="hierarchy-label">Head:</div>
                                    <div class="hierarchy-value"><?php echo htmlspecialchars($user_hierarchy['head_info']['head_name']); ?></div>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Notification dropdown functionality from homepage
