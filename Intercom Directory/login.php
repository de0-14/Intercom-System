...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Using SQL Server compatible query with sqlsrv
    $sql = "SELECT user_id, username, password, role_id, status FROM users WHERE username = ?";
...
<div class="main">
    <div class="card">
        ...
        <a href="signup.php"><button class="create-btn">Create Account</button></a>
        <?php if (!empty($error)): ?>
...
document.addEventListener('DOMContentLoaded', function() {
    const messages = document.querySelectorAll('p[style*="color:red"], p[style*="color:green"]');
    ...
    // Clean URL if it has a message parameter
