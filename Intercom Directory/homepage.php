...
/* Tooltip for circle button */
.admin-circle-tooltip {
    position: absolute;
    top: -40px;
    left: 50%;
...
.admin-online-container:hover .admin-circle-tooltip {
    opacity: 1;
    visibility: visible;
}
    ...
    <div class="contact-directory">
        ...
        <div class="header-section">
            ...
            <div class="admin-online-container">
                <div class="admin-circle-tooltip">Admins Online</div>
