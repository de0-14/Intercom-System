...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            /* On mobile, hide status column if needed */
    ...
    <div class="content">
        <div class="contact-directory">
            ...
            <div class="stats-summary">
                ...
                <div class="stat-item">
                    <div class="stat-value"><?php echo $decommissionedCount; ?></div>
                    <div class="stat-label">Decommissioned</div>
                </div>
            </div>
            
            <div class="search-filter">
                <input type="text" id="searchInput" placeholder="Search by contact number, head name, description, unit, or status..." onkeyup="filterSearch()">
            </div>
            ...
            <?php if ($totalContacts > 0): ?>
                <table class="contact-table" class="top-alligned-row" id="contacts-table">
                    <thead>
                    ...
                    <tbody class="top-alligned-row">
                        <?php foreach ($allNumbers as $contact): ?>
                            ...
                            ?>
                            <tr class="contact-row" data-type="<?php echo strtolower($contact['unit_type']); ?>" data-status="<?php echo isset($contact['status']) ? $contact['status'] : 'unknown'; ?>" vertical-align="top">
                                <td>
        ...
        function filterTable(type) {
            ...
            buttons.forEach(btn => {
                ...
                if ((type === 'all' && btn.textContent.includes('All')) ||
                    (type === 'division' && btn.textContent.includes('Divisions')) ||
                    (type === 'department' && btn.textContent.includes('Departments')) ||
                    (type === 'unit' && btn.textContent.includes('Units')) ||
                    (type === 'office' && btn.textContent.includes('Offices')) ||
                    (type === 'active' && btn.textContent.includes('Active')) ||
                    (type === 'decommissioned' && btn.textContent.includes('Decommissioned'))) {
            ...
            rows.forEach(row => {
                ...
                if (type === 'all') {
                    ...
                    // Filter by status
                    shouldShow = rowStatus === type;
                } else {
                    // Filter by organizational type
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            filterButtons.forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    else if (btnText.includes('Active')) filterType = 'active';
                    else if (btnText.includes('Decommissioned')) filterType = 'decommissioned';
