...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if (empty($divisionhead)) {
            throw new Exception("Unit Head is required.");
        }
        ...
        if ($checkStmt->num_rows > 0) {
            throw new Exception("Unit '$divisionName' already exists.");
        }
        $checkStmt->close();
        ...
        $response['message'] = "Unit '$divisionName' created successfully!";
...
<body>
    ...
    <div class="big-container">
        <h2>You are creating a new Unit</h2>
            ...
            <div class="form-group">
                ...
                <select id="division" name="under" required>
                    ...
                    <?php foreach ($divisions as $division): ?>
                        <option value="<?php echo $division['department_id']; ?>"
                            <?php echo isset($_POST['under']) && $_POST['under'] == $division['department_id'] ? 'selected' : ''; ?>>
                            <?php echo htmlspecialchars($division['department_name']); ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (!divisionName) {
                    showMessage('Unit name is required.');
                    return;
                }
                if (!divisionHead) {
                    showMessage('Unit Head is required.');
                    return;
                }
