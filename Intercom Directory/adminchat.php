...
<head>
    ...
    <style>
        * {
        ...
        .admin-select-item:hover .hierarchy-tooltip,
...
<body>
    ...
    <div class="header">
        ...
        <ul class="nav">
            ...
            <?php if (isLoggedIn()): ?>
                ...
                <?php else: ?>
                    <li><a href="adminchat.php" class="active">Chat with an Operator
                            <?php echo $unread_count > 0 ? "<span class='nav-notification-badge'>$unread_count</span>" : ""; ?></a>
                    </li>
                <?php endif; ?>
            ...
            <div class="chat-sidebar">
                ...
                <?php if ($is_admin || $archived_chats_count > 0): ?>
                    <div class="view-toggle">
                        ...
                        <a href="adminchat.php?view=archived"
                            class="view-toggle-btn <?php echo $view_archived ? 'active' : ''; ?>">Archived Chats
                            <?php if ($archived_chats_count > 0): ?><span
                                    class="archive-count-badge"><?php echo $archived_chats_count; ?></span><?php endif; ?>
                        </a>
                    </div>
                ...
                <div class="chat-list">
                        ...
                        <?php if (!empty($archived_chats)): ?>
                            <?php foreach ($archived_chats as $chat):
                                ...
                                <a href="adminchat.php?view=archived&chat_id=<?php echo $chat['chat_id']; ?>"
                                    ...
                                    <div class="chat-info">
                                        <div class="chat-name">
                                            <?php echo $is_admin ? htmlspecialchars($chat['full_name']) : htmlspecialchars($chat['full_name']); ?><span
                                                class="archive-badge">Archived</span>
                                        </div>
                                        <div class="chat-preview">
                                            <?php echo htmlspecialchars(substr($chat['last_message'] ?? 'No messages', 0, 30)); ?>
                                        </div>
                                    </div>
                                    <div class="chat-time">
                                        <?php if ($chat['archived_at']): ?>
                                            <?php echo date('M d', strtotime($chat['archived_at']->format('Y-m-d H:i:s'))); ?>
                                        <?php endif; ?>
                                    </div>
                                        ...
                                        <div class="hierarchy-info">
                                            <div class="hierarchy-row">
                                                ...
                                                <div class="hierarchy-value">
                                                    <?php echo htmlspecialchars($hierarchy_info['email'] ?? 'N/A'); ?>
                                                </div>
                                            </div>
                                            <div class="hierarchy-row">
                                                <div class="hierarchy-label">Role:</div>
                                                <div class="hierarchy-value">
                                                    <?php echo htmlspecialchars($hierarchy_info['role_name'] ?? 'N/A'); ?>
                                                    <?php if ($hierarchy_info['is_head']): ?><span
                                            ...
                                            <?php if ($hierarchy_info['current_unit']): ?>
                                                <div class="hierarchy-row">
                                                    ...
                                                    <div class="hierarchy-value">
                                                        <?php echo htmlspecialchars($hierarchy_info['current_unit']); ?>
                                                        <?php if ($hierarchy_info['unit_type']): ?><span
                                                                style="color: #a0aec0; font-size: 10px;">(<?php echo $hierarchy_info['unit_type']; ?>)</span><?php endif; ?>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                            ...
                                            <?php endif; ?>
                                            <?php if ($hierarchy_info['division']): ?>
                                                <div class="hierarchy-row">
                                                    <div class="hierarchy-label">Division:</div>
                                                    <div class="hierarchy-value">
                                                        <?php echo htmlspecialchars($hierarchy_info['division']); ?>
                                                    </div>
                                                </div><?php endif; ?>
                                            <?php if ($hierarchy_info['department']): ?>
                                                <div class="hierarchy-row">
                                                    <div class="hierarchy-label">Department:</div>
                                                    <div class="hierarchy-value">
                                                        <?php echo htmlspecialchars($hierarchy_info['department']); ?>
                                                    </div>
                                                </div><?php endif; ?>
                                            <?php if ($hierarchy_info['unit']): ?>
                                                <div class="hierarchy-row">
                                                    <div class="hierarchy-label">Unit:</div>
                                                    <div class="hierarchy-value">
                                                        <?php echo htmlspecialchars($hierarchy_info['unit']); ?>
                                                    </div>
                                                </div><?php endif; ?>
                                            <?php if ($hierarchy_info['office']): ?>
                                                <div class="hierarchy-row">
                                                    <div class="hierarchy-label">Office:</div>
                                                    <div class="hierarchy-value">
                                                        <?php echo htmlspecialchars($hierarchy_info['office']); ?>
                                                    </div>
                                                </div><?php endif; ?>
                                            <?php if ($hierarchy_info['head_info'] && isset($hierarchy_info['head_info']['head_name']) && !$hierarchy_info['is_head']): ?>
                                                ...
                                                <div class="hierarchy-row">
                                                    ...
                                                    <div class="hierarchy-value">
                                                        <?php echo htmlspecialchars($hierarchy_info['head_info']['head_name']); ?>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                    ...
                    <?php else: ?>
                        ...
                        if (!empty($chats)):
                            foreach ($chats as $chat):
                                ...
                                <a href="adminchat.php?chat_id=<?php echo $chat['chat_id']; ?>"
                                    ...
                                    <div class="chat-info">
                                        <div class="chat-name">
                                            <?php echo $is_admin ? htmlspecialchars($chat['full_name']) : htmlspecialchars($chat['full_name']); ?>
                                        </div>
                                        <div class="chat-preview">
                                            <?php echo htmlspecialchars(substr($chat['last_message'] ?? 'No messages yet', 0, 30)); ?>
                                        </div>
                                    </div>
                                    <div class="chat-time">
                                        <?php if ($chat['last_message_time']): ?>
                                            <?php echo date('H:i', strtotime($chat['last_message_time']->format('Y-m-d H:i:s'))); ?>
                                        <?php endif; ?>
                                    </div>
                            ...
                            <?php if (!$is_admin): ?>
                                <div class="admin-select-list">
                                    <h4
                                        style="color: #4a5568; font-size: 14px; margin: 15px 0 10px 0; border-top: 1px solid #e2e8f0; padding-top: 10px;">
                                        Start New Chat
                                    </h4>
                                    <?php
                                    ...
                                    foreach ($admins as $admin):
                                        ...
                                        if (!$has_active_chat):
                                            ...
                                            <a href="adminchat.php?start_chat=<?php echo $admin['user_id']; ?>" class="admin-select-item"
                                                data-admin-id="<?php echo $admin['user_id']; ?>">
                                                <div class="admin-select-avatar" style="position: relative;">
                                                ...
                                                <div class="admin-select-info" style="flex: 1; display: flex; align-items: center;">
                                                    <span
                                                ...
                                                <?php if ($has_archived): ?>
                                                    <span class="new-conversation-indicator">(Start fresh)</span>
                                                <?php endif; ?>

                                                <!-- Hierarchy tooltip remains the same -->
                                                <div class="hierarchy-tooltip">
                                                    <h4>
                                                        <?php echo htmlspecialchars($admin_hierarchy['full_name']); ?>
                                                    </h4>
                                                    <div class="hierarchy-info">
                                                        <div class="hierarchy-row">
                                                            <div class="hierarchy-label">Email:</div>
                                                            <div class="hierarchy-value">
                                                                <?php echo htmlspecialchars($admin_hierarchy['email'] ?? 'N/A'); ?>
                                                            </div>
                                                        </div>
                                                        <div class="hierarchy-row">
                                                            <div class="hierarchy-label">Role:</div>
                                                            <div class="hierarchy-value">
                                                                <?php echo htmlspecialchars($admin_hierarchy['role_name'] ?? 'Admin'); ?>
                                                                <?php if ($admin_hierarchy['is_head']): ?><span
                                                                        style="color: #38a169; font-weight: bold; margin-left: 5px;">(Head)</span>
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>
                                                        <?php if ($admin_hierarchy['current_unit']): ?>
                                                            <div class="hierarchy-row">
                                                                <div class="hierarchy-label">Current Unit:</div>
                                                                <div class="hierarchy-value">
                                                                    <?php echo htmlspecialchars($admin_hierarchy['current_unit']); ?>
                                                                    <?php if ($admin_hierarchy['unit_type']): ?><span
                                                                            style="color: #a0aec0; font-size: 10px;">(
                                                                            <?php echo $admin_hierarchy['unit_type']; ?>)
                                                                        </span>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <?php endif; ?>
                                                        <?php if ($admin_hierarchy['division']): ?>
                                                            <div class="hierarchy-row">
                                                                <div class="hierarchy-label">Division:</div>
                                                                <div class="hierarchy-value">
                                                                    <?php echo htmlspecialchars($admin_hierarchy['division']); ?>
                                                                </div>
                                                            </div>
                                                        <?php endif; ?>
                                                        <?php if ($admin_hierarchy['department']): ?>
                                                            <div class="hierarchy-row">
                                                                <div class="hierarchy-label">Department:</div>
                                                                <div class="hierarchy-value">
                                                                    <?php echo htmlspecialchars($admin_hierarchy['department']); ?>
                                                                </div>
                                                            </div>
                                                        <?php endif; ?>
                                                        <?php if ($admin_hierarchy['unit']): ?>
                                                            <div class="hierarchy-row">
                                                                <div class="hierarchy-label">Unit:</div>
                                                                <div class="hierarchy-value">
                                                                    <?php echo htmlspecialchars($admin_hierarchy['unit']); ?>
                                                                </div>
                                                            </div>
                                                        <?php endif; ?>
                                                        <?php if ($admin_hierarchy['office']): ?>
                                                            <div class="hierarchy-row">
                                                                <div class="hierarchy-label">Office:</div>
                                                                <div class="hierarchy-value">
                                                                    <?php echo htmlspecialchars($admin_hierarchy['office']); ?>
                                                                </div>
                                                            </div>
                                                        <?php endif; ?>
                                                        <?php if ($admin_hierarchy['head_info'] && isset($admin_hierarchy['head_info']['head_name']) && !$admin_hierarchy['is_head']): ?>
                                                            ...
                                                            <div class="hierarchy-row">
                                                                <div class="hierarchy-label">Head:</div>
                                                                <div class="hierarchy-value">
                                                                    <?php echo htmlspecialchars($admin_hierarchy['head_info']['head_name']); ?>
                                                                </div>
                                                            </div>
                                                        <?php endif; ?>
                                                    </div>
                        ...
                        <?php elseif (!$is_admin): ?>
                            <div class="admin-select-list">
                                <h4 style="color: #4a5568; font-size: 14px; margin: 15px 0 10px 0;">Select an Operator to Chat
                                    With</h4>
                                <?php
                                $admins = getAvailableAdmins($conn);
                                foreach ($admins as $admin):
                                                ...
                                                <?php if ($admin_hierarchy['current_unit']): ?>
                                                    <div class="hierarchy-row">
                                                        ...
                                                        <div class="hierarchy-value">
                                                            <?php echo htmlspecialchars($admin_hierarchy['current_unit']); ?>
                                                            <?php if ($admin_hierarchy['unit_type']): ?><span
                                                                    style="color: #a0aec0; font-size: 10px;">(<?php echo $admin_hierarchy['unit_type']; ?>)</span><?php endif; ?>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if ($admin_hierarchy['is_head'] && !empty($admin_hierarchy['heads_contacts'])): ?>
            ...
            <div class="chat-main">
                <?php if ($selected_chat): ?>
                    <div class="chat-header <?php echo $view_archived ? 'archived-chat' : ''; ?>"
                        style="<?php echo $view_archived ? 'background: #f1f5f9; border-color: #cbd5e0;' : ''; ?>">
                        <h3 style="<?php echo $view_archived ? 'color: #4a5568;' : ''; ?>">
                            <?php if ($view_archived): ?>📁 Archived Chat with
                                <?php echo $is_admin ? htmlspecialchars($selected_chat['other_full_name'] ?? $selected_chat['full_name']) : htmlspecialchars($selected_chat['other_full_name'] ?? $selected_chat['full_name']); ?>
                            <?php else: ?>Chat with
                                <?php echo $is_admin ? htmlspecialchars($selected_chat['full_name']) : 'Admin ' . htmlspecialchars($selected_chat['full_name']); ?>
                            <?php endif; ?>
                        </h3>
                    </div>
                            ...
                            <div class="message <?php echo $is_sent ? 'sent' : 'received'; ?>">
                                        ...
                                        <div class="hierarchy-info">
                                            ...
                                            <div class="hierarchy-row">
                                                ...
                                                <div class="hierarchy-value">
                                                    ...
                                                    <?php if ($sender_hierarchy['is_head']): ?><span
                                                            style="color: #38a169; font-weight: bold; margin-left: 5px;">(Head)</span><?php endif; ?>
                                                </div>
                                            </div>
                                            <?php if ($sender_hierarchy['current_unit']): ?>
                                                <div class="hierarchy-row">
                                                    ...
                                                    <div class="hierarchy-value">
                                                        ...
                                                        <?php if ($sender_hierarchy['unit_type']): ?><span
                                            ...
                                            <?php endif; ?>
                                            <?php if ($sender_hierarchy['division']): ?>
                                                <div class="hierarchy-row">
                                                    <div class="hierarchy-label">Division:</div>
                                                    <div class="hierarchy-value">
                                            ...
                                            <?php if ($sender_hierarchy['department']): ?>
                                                <div class="hierarchy-row">
                                                    <div class="hierarchy-label">Department:</div>
                                                    <div class="hierarchy-value">
                                            ...
                                            <?php if ($sender_hierarchy['office']): ?>
                                                <div class="hierarchy-row">
                                                    <div class="hierarchy-label">Office:</div>
                                                    <div class="hierarchy-value">
                                ...
                                <div class="message-bubble">
                                    ...
                                    <div class="message-time">
                                        <?php echo date('H:i', strtotime($msg['created_at']->format('Y-m-d H:i:s'))); ?>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    ...
                    <?php else: ?>
                        <div class="chat-input-area" style="background-color: #f1f5f9; border-top: 1px solid #cbd5e0;">
                            <div style="text-align: center; padding: 15px; color: #64748b; font-style: italic;">This chat is
                                archived and cannot be modified.</div>
                        </div>
                    <?php endif; ?>
                <?php else: ?>
                    <div class="no-chat-selected">
                        <div>
                            ...
                            <?php if (!$is_admin): ?>
                                <p>You can chat with any available admin</p><?php endif; ?>

                            <?php if ($view_archived): ?>
                                <div
                                    style="margin-top: 20px; padding: 15px; background: #f7fafc; border-radius: 8px; border: 1px solid #e2e8f0;">
                                    <h4>📁 Archived Chats</h4>
                                    <p style="font-size: 14px; color: #4a5568;">Archived chats appear here. Select a chat to
                                        view its messages.</p>
                                </div>
                            <?php endif; ?>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            let isSending = false;
            let lastUnreadCounts = new Map(); // Track unread counts per chat
            ...
            // Replace the updateAllUnreadIndicators function with this debug version:

            function updateAllUnreadIndicators() {
                // Only for non-admin users (regular users chatting with admins)
                if (isAdmin) return;

                console.log('Updating unread indicators...');

                // Update indicators for each admin in the list
                document.querySelectorAll('.admin-select-item').forEach(item => {
                    ...
                    fetch(`check_admin_unread.php?admin_id=${adminId}&t=${Date.now()}`)
                        .then(response => {
                            console.log('Response status:', response.status);
                            return response.text().then(text => {
                                console.log('Raw response for admin', adminId, ':', text.substring(0, 200));
                                try {
                                    return JSON.parse(text);
                                } catch (e) {
                                    console.error('JSON parse error for admin', adminId, ':', e);
                        ...
                        .then(data => {
                            if (data.success) {
                                const avatar = item.querySelector('.admin-select-avatar');
                                const infoDiv = item.querySelector('.admin-select-info');
                                const dotSpan = avatar ? avatar.querySelector('.unread-dot') : null;
                                const countSpan = infoDiv ? infoDiv.querySelector('.unread-count') : null;

                                if (data.unread > 0) {
                                    console.log('Admin', adminId, 'has', data.unread, 'unread messages');
                                    ...
                                    if (infoDiv) {
                                        if (!countSpan) {
                                            ...
                                            countSpan.textContent = data.unread;
                                ...
                                console.error('Error from server for admin', adminId, ':', data.error);
                            }
                        })
                        .catch(error => console.error('Fetch error for admin', adminId, ':', error));
                });

                // Update chat list items (existing chats)
                document.querySelectorAll('.chat-item').forEach(item => {
                    ...
                    if (match) {
                        ...
                        fetch(`check_chat_unread.php?chat_id=${chatId}&t=${Date.now()}`)
                            .then(response => {
                                console.log('Response status:', response.status);
                                return response.text().then(text => {
                            ...
                            .then(data => {
                                if (data.success) {
                                    ...
                                    if (data.unread > 0) {
                                        console.log('Chat', chatId, 'has', data.unread, 'unread messages');

                                        // Add red dot to avatar
                                        if (avatar) {
                                            if (!dotSpan) {
                                                const newDot = document.createElement('span');
                                                newDot.className = 'unread-dot';
                                        ...
                                        // Remove indicators if no unread messages
                                        if (dotSpan) dotSpan.style.display = 'none';
                                        if (badgeSpan) badgeSpan.style.display = 'none';
                                    }
                                } else {
                                    console.error('Error from server for chat', chatId, ':', data.error);
                                }
                            })
                            .catch(error => console.error('Fetch error for chat', chatId, ':', error));
                    }
                });
            }
                ...
                fetch(`get_admin_messages.php?chat_id=${chatId}&last_message_id=${lastMessageId}`)
                    ...
                    .then(data => {
                        if (data.success && data.messages && data.messages.length > 0) {
                            ...
                            // Update unread indicators for all chats
                            updateAllUnreadIndicators();
                        }
                    })
            ...
            function appendMessages(messages) {
                ...
                messages.forEach(msg => {
                    ...
                    // Add "replying" indicator for admin messages
                    const isAdminMessage = !msg.is_sent; // Message from admin to user

                    messageDiv.innerHTML = `
                <div class="message-sender">
                    ${escapeHtml(msg.full_name)}
                    ${isAdminMessage ? '<span class="replying-indicator" title="Admin is replying">👨‍⚕️</span>' : ''}
                </div>
                <div class="message-bubble">
            ...
            function setupNotificationPermission() {
                ...
                const notificationHint = document.createElement('div');
                notificationHint.className = 'notification-hint';
                notificationHint.innerHTML = '🔔 Enable desktop notifications for new messages? <button class="btn-enable">Enable</button>';
        ...
        `;
                ...
                const enableBtn = notificationHint.querySelector('.btn-enable');
        ...
        `;
                ...
                setTimeout(() => {
                    if (notificationHint.parentNode) {
                        notificationHint.remove();
                    }
                }, 30000);

                document.body.appendChild(notificationHint);
            }
            ...
            document.addEventListener('visibilitychange', function () {
                if (document.hidden) {
                    ...
                    // Update indicators when page becomes visible
                    updateAllUnreadIndicators();
                }
            });
            ...
            // Set up periodic update of unread indicators (every 10 seconds)
            setInterval(updateAllUnreadIndicators, 10000);
            ...
            // Initial update of unread indicators
            setTimeout(updateAllUnreadIndicators, 1000);
        });
    </script>

    <style>
        /* Additional styles for the new indicators */
        .unread-indicator {
