    ...
    if(isset($_POST['send_message'])) {
        ...
        if(empty($message)) {
            ...
            if(sendAdminMessage($conn, $chat_id, $user_id, $message)) {
                ...
                if (isset($selected_chat)) {
                    $admin_id_to_check = $is_admin ? $user_id : ($selected_chat['admin_id'] ?? 0);
                    $user_id_to_check = $is_admin ? ($selected_chat['user_id'] ?? 0) : $user_id;
...
/* FIXED TOOLTIP STYLES - SIMPLE VERSION */
.hierarchy-tooltip {
    position: absolute;
    background: #2d3748;
    color: white;
...
/* Ensure parent elements are positioned */
.chat-item, .admin-select-item, .message-sender {
    position: relative;
}
</style>
</head>
                ...
                <?php if ($view_archived): ?>
                    ...
                    <?php if(!empty($archived_chats)): ?>
                        <?php foreach($archived_chats as $chat): 
                            // Get user hierarchy info for tooltip
                            ...
                            <div class="hierarchy-tooltip">
                                ...
                                <div class="hierarchy-info">
                                    <div class="hierarchy-row">
                                        ...
                                        <div class="hierarchy-value"><?php echo htmlspecialchars($hierarchy_info['role_name'] ?? 'N/A'); ?></div>
                                    </div>
                                    <?php if ($hierarchy_info['position']): ?>
                                    <div class="hierarchy-row">
                                        <div class="hierarchy-label">Position:</div>
                                        <div class="hierarchy-value"><?php echo htmlspecialchars($hierarchy_info['position']); ?></div>
                                    </div>
                                    <?php endif; ?>
                                    <?php if ($hierarchy_info['division']): ?>
                                    <div class="hierarchy-row">
                                        <div class="hierarchy-label">Division:</div>
                                        <div class="hierarchy-value"><?php echo htmlspecialchars($hierarchy_info['division']); ?></div>
                                    </div>
                                    <?php endif; ?>
                                    <?php if ($hierarchy_info['department']): ?>
                                    <div class="hierarchy-row">
                                        <div class="hierarchy-label">Department:</div>
                                        <div class="hierarchy-value"><?php echo htmlspecialchars($hierarchy_info['department']); ?></div>
                                    </div>
                                    <?php endif; ?>
                                    <?php if ($hierarchy_info['unit']): ?>
                                    <div class="hierarchy-row">
                                        <div class="hierarchy-label">Unit:</div>
                                        <div class="hierarchy-value"><?php echo htmlspecialchars($hierarchy_info['unit']); ?></div>
                                    </div>
                                    <?php endif; ?>
                                    <?php if ($hierarchy_info['office']): ?>
                                    <div class="hierarchy-row">
                                        <div class="hierarchy-label">Office:</div>
                                        <div class="hierarchy-value"><?php echo htmlspecialchars($hierarchy_info['office']); ?></div>
                                    </div>
                                    <?php endif; ?>
                                    <?php if ($hierarchy_info['head_info'] && isset($hierarchy_info['head_info']['head_name'])): ?>
                                    <div class="hierarchy-divider"></div>
                                    <div class="hierarchy-row">
                                        <div class="hierarchy-label">Head:</div>
                                        <div class="hierarchy-value"><?php echo htmlspecialchars($hierarchy_info['head_info']['head_name']); ?></div>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="admin-select-list">
                            ...
                            foreach($admins as $admin):
                                ...
                                if (!$has_active_chat):
                                    ...
                                    // Get admin hierarchy info for tooltip
                            ...
                            <a href="adminchat.php?start_chat=<?php echo $admin['user_id']; ?>" class="admin-select-item">
                                ...
                                <div class="hierarchy-tooltip">
                                    ...
                                    <div class="hierarchy-info">
                                        <div class="hierarchy-row">
                                            <div class="hierarchy-label">Role:</div>
                                            <div class="hierarchy-value"><?php echo htmlspecialchars($admin_hierarchy['role_name'] ?? 'Admin'); ?></div>
                                        </div>
                                        <?php if ($admin_hierarchy['position']): ?>
                                        <div class="hierarchy-row">
                                            <div class="hierarchy-label">Position:</div>
                                            <div class="hierarchy-value"><?php echo htmlspecialchars($admin_hierarchy['position']); ?></div>
                                        </div>
                                        <?php endif; ?>
                                        <?php if ($admin_hierarchy['division']): ?>
                                        <div class="hierarchy-row">
                                            <div class="hierarchy-label">Division:</div>
                                            <div class="hierarchy-value"><?php echo htmlspecialchars($admin_hierarchy['division']); ?></div>
                                        </div>
                                        <?php endif; ?>
                                        <?php if ($admin_hierarchy['department']): ?>
                                        <div class="hierarchy-row">
                                            <div class="hierarchy-label">Department:</div>
                                            <div class="hierarchy-value"><?php echo htmlspecialchars($admin_hierarchy['department']); ?></div>
                                        </div>
                                        <?php endif; ?>
                                        <?php if ($admin_hierarchy['unit']): ?>
                                        <div class="hierarchy-row">
                                            <div class="hierarchy-label">Unit:</div>
                                            <div class="hierarchy-value"><?php echo htmlspecialchars($admin_hierarchy['unit']); ?></div>
                                        </div>
                                        <?php endif; ?>
                                        <?php if ($admin_hierarchy['office']): ?>
                                        <div class="hierarchy-row">
                                            <div class="hierarchy-label">Office:</div>
                                            <div class="hierarchy-value"><?php echo htmlspecialchars($admin_hierarchy['office']); ?></div>
                                        </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
            ...
            <?php if($selected_chat): ?>
                ...
                <div class="chat-messages <?php echo $view_archived ? 'archived-chat' : ''; ?>" id="chat-messages">
                    <?php foreach($chat_messages as $msg): 
                        ...
                        // Get sender hierarchy info for tooltip
                    ...
                    <div class="message <?php echo $is_sent ? 'sent' : 'received'; ?>">
                        <div class="message-sender">
                            ...
                            <!-- Hierarchy Tooltip for Message Sender -->
                            <div class="hierarchy-tooltip">
                                <h4><?php echo htmlspecialchars($sender_hierarchy['full_name']); ?></h4>
                                <div class="hierarchy-info">
                                    <div class="hierarchy-row">
                                        <div class="hierarchy-label">Role:</div>
                                        <div class="hierarchy-value"><?php echo htmlspecialchars($sender_hierarchy['role_name'] ?? 'N/A'); ?></div>
                                    </div>
                                    <?php if ($sender_hierarchy['position']): ?>
                                    <div class="hierarchy-row">
                                        <div class="hierarchy-label">Position:</div>
                                        <div class="hierarchy-value"><?php echo htmlspecialchars($sender_hierarchy['position']); ?></div>
                                    </div>
                                    <?php endif; ?>
                                    <?php if ($sender_hierarchy['division']): ?>
                                    <div class="hierarchy-row">
                                        <div class="hierarchy-label">Division:</div>
                                        <div class="hierarchy-value"><?php echo htmlspecialchars($sender_hierarchy['division']); ?></div>
                                    </div>
                                    <?php endif; ?>
                                    <?php if ($sender_hierarchy['department']): ?>
                                    <div class="hierarchy-row">
                                        <div class="hierarchy-label">Department:</div>
                                        <div class="hierarchy-value"><?php echo htmlspecialchars($sender_hierarchy['department']); ?></div>
                                    </div>
                                    <?php endif; ?>
                                    <?php if ($sender_hierarchy['unit']): ?>
                                    <div class="hierarchy-row">
                                        <div class="hierarchy-label">Unit:</div>
                                        <div class="hierarchy-value"><?php echo htmlspecialchars($sender_hierarchy['unit']); ?></div>
                                    </div>
                                    <?php endif; ?>
                                    <?php if ($sender_hierarchy['office']): ?>
                                    <div class="hierarchy-row">
                                        <div class="hierarchy-label">Office:</div>
                                        <div class="hierarchy-value"><?php echo htmlspecialchars($sender_hierarchy['office']); ?></div>
                                    </div>
                                    <?php endif; ?>
                                    <?php if ($sender_hierarchy['head_info'] && isset($sender_hierarchy['head_info']['head_name'])): ?>
                                    <div class="hierarchy-divider"></div>
                                    <div class="hierarchy-row">
                                        <div class="hierarchy-label">Head:</div>
                                        <div class="hierarchy-value"><?php echo htmlspecialchars($sender_hierarchy['head_info']['head_name']); ?></div>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
