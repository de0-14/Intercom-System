    ...
    <div class="header">
        ...
        <ul class="nav">
            ...
            <?php if (isLoggedIn()): ?>
                ...
                <?php else: ?>
                    <li><a href="adminchat.php">Chat with an Operator
                            <?php echo $user_unread > 0 ? "($user_unread)" : ""; ?></a></li>
                <?php endif; ?>
                    ...
                    <form method="POST" class="edit-form" id="edit-contact-form">
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <select id="status" name="status" class="form-control">
                                    <option value="active" <?php echo $contact['status'] == 'active' ? 'selected' : ''; ?>>
                                        Active</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="form-control" rows="3"
                                required><?php echo htmlspecialchars($contact['description']); ?></textarea>
                        </div>
                ...
                <div class="contact-title">
                    ...
                    <div class="contact-title-text">
                        ...
                        <div class="description">
                            <?php echo htmlspecialchars($contact['description'] ?? 'No description'); ?>
                        </div>
                    </div>
                </div>
                <div style="display: flex; gap: 10px; align-items: center;">
                    <?php if ($is_head && !$is_editing): ?>
                        <a href="<?php echo $current_script; ?>?id=<?php echo $number_id; ?>&edit=true" class="edit-btn">✏️
                            Edit Contact</a>
                    <?php endif; ?>
            ...
            <div class="contact-details">
                <div class="detail-section">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value"><?php echo htmlspecialchars($contact['description'] ?? 'N/A'); ?>
                        </div>
                    </div>
                    <div class="detail-item">
                        ...
                        <div class="detail-value">
                            <?php if (isset($contact['status'])): ?>
                                <span
                                    class="status-badge <?php echo $contact['status'] === 'active' ? 'status-active' : 'status-decommissioned'; ?>">
                ...
                <div class="detail-section">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value head-value">
                            <?php echo htmlspecialchars($contact['head'] ?? 'Not assigned'); ?>
                        </div>
                    </div>
                </div>
                    ...
                    <?php if ($org_name): ?>
                        <div class="detail-item">
                            ...
                            <div class="detail-value">
                                ...
                                <?php if ($org_status): ?>
                                    <span
                                        class="status-badge <?php echo $org_status === 'active' ? 'status-active' : 'status-decommissioned'; ?>">
            ...
            <div class="section-header">
                ...
                <div class="rating-summary">
                    ...
                    <div>
                        ...
                        <div class="total-feedbacks" id="total-feedbacks">Based on <?php echo $total_feedbacks; ?>
                            reviews</div>
                    </div>
                </div>
            </div>
                ...
                <div class="feedback-form editing" id="edit-feedback-form">
                    ...
                    <form id="feedback-edit-form">
                        <input type="hidden" name="feedback_id"
                            value="<?php echo $current_edit_feedback['feedback_id']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="edit-comment" name="comment" placeholder="Update your feedback..."
                                required><?php echo htmlspecialchars($current_edit_feedback['comment']); ?></textarea>
                        </div>
                ...
                <div class="feedback-form" id="new-feedback-form">
                    ...
                    <form id="feedback-submit-form">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="comment" name="comment" placeholder="Share your experience with this contact..."
                                required></textarea>
                        </div>
                        ...
                        <div class="feedback-item <?php echo $is_own_feedback ? 'own-feedback' : ''; ?>"
                            ...
                            <?php if ($is_own_feedback && !$edit_feedback_id): ?>
                                <div class="feedback-actions-small">
                                    <a href="<?php echo $current_script; ?>?id=<?php echo $number_id; ?>&edit_feedback=<?php echo $feedback['feedback_id']; ?>"
                                        class="edit-btn-small">Edit</a>
                                    <button class="delete-btn small-btn delete-feedback-btn"
                                        data-feedback-id="<?php echo $feedback['feedback_id']; ?>">Delete</button>
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; ?>
                            ...
                            <div class="chat-header" style="background-color: #718096;">
                                <h3>
                                    ...
                                    <?php if ($user_id == $selected_conversation_info['initiated_by']): ?>
                                        with
                                        <?php echo htmlspecialchars($selected_conversation_info['head_name'] ?? $contact['head']); ?>
                                    <?php else: ?>
                                ...
                                <a href="<?php echo $current_script; ?>?id=<?php echo $number_id; ?>&view=archived"
                                    class="chat-back-btn">← Back to Archive</a>
                            </div>

                            <div class="archive-info-bar"
                                style="background: #e8f4fd; padding: 10px 15px; border-bottom: 1px solid #b6d4fe;">
                                <div style="display: flex; justify-content: space-between; font-size: 13px;">
                                    <div>
                                        <strong>Started:</strong>
                                        <?php echo formatDateForDisplay($selected_conversation_info['created_at']); ?>
                                        | <strong>Last Activity:</strong>
                                        <?php echo formatDateForDisplay($selected_conversation_info['last_activity']); ?>
                                        | <strong>Archived:</strong>
                                        <?php echo formatDateForDisplay($selected_conversation_info['archived_at']); ?>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="user-profile-tooltip">
                                                    ...
                                                    <div class="user-profile-details">
                                                        <div class="profile-detail-row">
                                                            ...
                                                            <span
                                                                class="profile-detail-value"><?php echo htmlspecialchars($user_info['role_name'] ?? 'Unknown'); ?></span>
                                                        </div>
                                                        <?php if ($user_info['division']): ?>
                                                            <div class="profile-detail-row">
                                                                <span class="profile-detail-label">Division:</span>
                                                                <span
                                                                    class="profile-detail-value"><?php echo htmlspecialchars($user_info['division']); ?></span>
                                                            </div>
                                                        <?php endif; ?>
                                                        <?php if ($user_info['department']): ?>
                                                            <div class="profile-detail-row">
                                                                ...
                                                                <span
                                                                    class="profile-detail-value"><?php echo htmlspecialchars($user_info['department']); ?></span>
                                                            </div>
                                                        <?php endif; ?>
                                                        <?php if ($user_info['unit']): ?>
                                                            <div class="profile-detail-row">
                                                                ...
                                                                <span
                                                                    class="profile-detail-value"><?php echo htmlspecialchars($user_info['unit']); ?></span>
                                                            </div>
                                                        <?php endif; ?>
                                                        <?php if ($user_info['office']): ?>
                                                            <div class="profile-detail-row">
                                                                ...
                                                                <span
                                                                    class="profile-detail-value"><?php echo htmlspecialchars($user_info['office']); ?></span>
                                                            </div>
                                                        <?php endif; ?>
                                                    </div>
                                                    ...
                                                    <?php elseif (!empty($user_info['head_info'])): ?>
                                                        ...
                                                        <div class="user-profile-head-info">
                                                            ...
                                                            <?php if (!empty($user_info['head_info']['head_email'])): ?>
                                                                <br><small>Email:
                                                                    <?php echo htmlspecialchars($user_info['head_info']['head_email']); ?></small>
                                                            <?php endif; ?>
                                                        </div>
                                                    <?php else: ?>
                                                        <hr class="user-profile-divider">
                            ...
                            <tbody>
                                <?php foreach ($conversations as $conv): ?>
                                    <tr>
                                        ...
                                        <td><span class="archived-message-count"><?php echo $conv['message_count']; ?> messages</span>
                                        </td>
                        ...
                        <div class="chat-container">
                            <div class="chat-header">
                                <h3 id="chat-header-title">
                                    ...
                                    <?php else: ?>
                                        Chat with
                                        <?php echo htmlspecialchars($selected_conversation_info['initiator_name'] ?? 'User'); ?>
                                    <?php endif; ?>
                                </h3>
                                <a href="<?php echo $current_script; ?>?id=<?php echo $number_id; ?>" class="chat-back-btn">← Back
                                    to Conversations</a>
                            </div>
                            ...
                            <div class="chat-input-area">
                                <form class="chat-input-form" id="chat-form">
                                    <input type="hidden" name="conversation_id" id="conversation_id"
                                        value="<?php echo $selected_conversation_id; ?>">
                                    ...
                                    <?php if ($user_id == $selected_conversation_info['initiated_by']): ?>
                                        <textarea class="chat-input" id="message-input" placeholder="Type your message here..."
                                            required></textarea>
                                        <button type="submit" class="chat-send-btn" id="send-message-btn">📤</button>
                                    <?php else: ?>
                                        <textarea class="chat-input" id="reply-input" placeholder="Type your reply here..."
                                            required></textarea>
                            ...
                            <div class="message-form">
                                ...
                                <form id="new-conversation-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="new-message" name="message" placeholder="Type your message here..."
                                            required></textarea>
                                    </div>
                                    <div class="form-actions">
...
<script>
    ...
    <!-- ===========================================
         HEAD UNREAD MESSAGE INDICATORS - FOR ALL USERS
         =========================================== -->
    <script>
        // ===========================================
        // HEAD UNREAD MESSAGE INDICATORS
        // ===========================================

        function updateHeadUnreadIndicators() {
            // Get config values
            let config;
            try {
                config = JSON.parse(document.getElementById('page-config').textContent);
            } catch (e) {
                console.error('Failed to load page config for unread indicators');
                return;
            }
            ...
            fetch('check_notifications.php?t=' + Date.now())
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        const relevantMessages = (data.notifications || []).filter(n => 
                            (n.type === 'head_message' || n.type === 'admin_reply') && n.number_id == numberId
                        );

                        // Calculate total unread for this number
                        let totalUnread = 0;
                        relevantMessages.forEach(notif => {
                            totalUnread += notif.unread_count || 1;
                        });

                        // Update the chat header to show unread count
                        const chatHeader = document.getElementById('chat-header-title');
                        if (chatHeader) {
                            let badge = chatHeader.querySelector('.unread-head-badge');
                            
                            if (totalUnread > 0) {
                                if (!badge) {
                                    badge = document.createElement('span');
                                    badge.className = 'unread-head-badge';
                                    badge.style.cssText = `
                                        background-color: #e53e3e;
                                        color: white;
                                        font-size: 12px;
                        ...
                        // Update conversation list items with unread indicators
                        document.querySelectorAll('.conversation-item').forEach(item => {
                            const convHref = item.getAttribute('href');
                            const convMatch = convHref.match(/conversation_id=(\d+)/);

                            if (convMatch) {
                                const convId = convMatch[1];
                                
                                // Check if this conversation has unread messages
                                fetch(`check_conversation_unread.php?conversation_id=${convId}&t=${Date.now()}`)
                                    .then(response => response.json())
                                    .then(data => {
                                        if (data.success && data.unread > 0) {
                                            // Add has-unread class to the item
                                            item.classList.add('has-unread');
                                            
                                            // Add red dot to conversation-with
                                            const withSpan = item.querySelector('.conversation-with');
                                            if (withSpan && !withSpan.querySelector('.unread-dot')) {
                                                ...
                                                dot.style.cssText = `
                                                    ...
                                                    animation: pulse 1.5s infinite;
                                                `;
                                                withSpan.appendChild(dot);
                                            }

                                            // Add red indicator to preview
                                            const preview = item.querySelector('.conversation-preview');
                                            if (preview && !preview.innerHTML.includes('🔴')) {
                                                preview.innerHTML = '🔴 ' + preview.innerHTML;
                                            }

                                            // Add count badge to meta
                                            const meta = item.querySelector('.conversation-meta');
                                            if (meta) {
                                                let badge = meta.querySelector('.unread-count-badge');
                                                if (!badge) {
                                                    badge = document.createElement('span');
                                    ...
                                    .catch(error => console.error('Error checking conversation unread:', error));
                            }
                        });
                    }
                })
                .catch(error => console.error('Error updating head unread indicators:', error));
        }

        // Override appendMessage to update indicators when new messages arrive
        if (typeof appendMessage === 'function') {
            const originalAppendMessage = appendMessage;
            window.appendMessage = function(msg) {
                originalAppendMessage(msg);
                
                // If this is a message from another user, update indicators
                let config;
                try {
                    config = JSON.parse(document.getElementById('page-config').textContent);
                } catch (e) {
                ...
                if (config.userId && msg && !msg.is_sent) {
                    setTimeout(updateHeadUnreadIndicators, 500);
                }
            };
        }

        // Start polling for head unread indicators
        document.addEventListener('DOMContentLoaded', function() {
            // Get config
            let config;
            try {
            ...
            if (userId && !viewArchived) {
                // Initial update after a delay
                setTimeout(updateHeadUnreadIndicators, 1500);
                
                // Update every 10 seconds
                setInterval(updateHeadUnreadIndicators, 10000);
            }
        });
        ...
        document.addEventListener('visibilitychange', function() {
            ...
            if (!document.hidden && userId && !viewArchived) {
                updateHeadUnreadIndicators();
            }
        });
    </script>
