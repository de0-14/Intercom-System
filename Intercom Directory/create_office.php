...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($checkStmt->num_rows > 0) {
            throw new Exception("Office '$divisionName' already exists.");
        }
        $checkStmt->close();
        ...
        $response['message'] = "Office '$divisionName' created successfully!";
            ...
            <div class="form-group">
                ...
                <select id="division" name="under" required>
                    ...
                    <?php foreach ($divisions as $division): ?>
                        <option value="<?php echo $division['unit_id']; ?>"
                            <?php echo isset($_POST['under']) && $_POST['under'] == $division['unit_id'] ? 'selected' : ''; ?>>
