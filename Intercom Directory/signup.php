    ...
    if(empty($error)) {
        ...
        if(mysqli_stmt_num_rows($check_stmt) > 0) {
            ...
            try {
                ...
                $user_sql = "INSERT INTO users (username, email, full_name, password, role_id) VALUES (?, ?, ?, ?, 7)";
                ...
                mysqli_stmt_bind_param($user_stmt, "ssss", $username, $email, $fullname, $password_hash);
